...
def get_posts(request):
    ...
    and render them in the 'blogposts.html' template
    """
    posts = Post.objects.filter(published_date__lte=timeezone.now().orderBy('-published_date'))
...
def post_detail(request, pk):
    ...
    'postdetail.html' template. Or return an error if
